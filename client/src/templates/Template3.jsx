...
function Template3({ data, isPreview = false }) {
  ...
  // Engineering style — condensed, single-column with bold headings
  return (
    <div className={`${isPreview ? 'max-w-4xl mx-auto shadow-lg' : ''} bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 p-8`} style={{fontFamily: 'Arial, sans-serif'}}> 
      ...
      <main className="space-y-6">
        ...
        {skills && skills.length > 0 && (
          <section>
            <h2 className="text-lg font-bold text-gray-900 dark:text-white mb-4 uppercase tracking-wide border-b border-gray-300 dark:border-gray-600 pb-1">Skills</h2>
